...
FST_TEST_BEGIN(core_asr)
{
	...
	sprintf(path, "%s%s%s%s", "file_string://silence_stream://3000,0!", SWITCH_TEST_BASE_DIR_FOR_CONF, SWITCH_PATH_SEPARATOR, "sounds/agent.wav!silence_stream://3000,0");
	fst_test_core_asr(
		grammar,
		path);
	...
	fst_test_core_asr_resume();
	sprintf(path, "%s%s%s%s", "file_string://", SWITCH_TEST_BASE_DIR_FOR_CONF, SWITCH_PATH_SEPARATOR, "sounds/agent.wav!silence_stream://3000,0");
	fst_test_core_asr(
		grammar,
		path);
	fst_check_string_equals(get_query_result_text(fst_pool, fst_asr_result), "agent");
	...
	fst_test_core_asr_open("test");
	sprintf(path, "%s%s%s%s", "file_string://silence_stream://1000,0!", SWITCH_TEST_BASE_DIR_FOR_CONF, SWITCH_PATH_SEPARATOR, "sounds/ivr-please_state_your_name_and_reason_for_calling.wav!silence_stream://3000,0");
	fst_test_core_asr(
		grammar,
		path);
	fst_check_string_equals(get_query_result_text(fst_pool, fst_asr_result), "agent");
...
FST_SESSION_BEGIN(play_and_detect_1)
{
	...
	sprintf(path, "%s%s%s", SWITCH_TEST_BASE_DIR_FOR_CONF, SWITCH_PATH_SEPARATOR, "sounds/ivr-please_state_your_name_and_reason_for_calling.wav");
	sprintf(path2, "%s%s%s", SWITCH_TEST_BASE_DIR_FOR_CONF, SWITCH_PATH_SEPARATOR, "sounds/agent.wav");
	...
	/* follow up request */
	sprintf(path, "%s%s%s", SWITCH_TEST_BASE_DIR_FOR_CONF, SWITCH_PATH_SEPARATOR, "sounds/ivr-please_state_your_name_and_reason_for_calling.wav");
	sprintf(path2, "%s%s%s%s", "file_string://1000,0!", SWITCH_TEST_BASE_DIR_FOR_CONF, SWITCH_PATH_SEPARATOR, "sounds/agent.wav");
	fst_play_and_detect_speech_app_test("test",
		grammar,
		path,
		path2);
...
FST_SESSION_BEGIN(play_and_detect_no_input_follow_up)
{
	...
	fst_play_and_detect_speech_test_begin();
	sprintf(path, "%s%s%s", SWITCH_TEST_BASE_DIR_FOR_CONF, SWITCH_PATH_SEPARATOR, "sounds/ivr-please_state_your_name_and_reason_for_calling.wav");
	sprintf(path2, "%s%s%s%s", "file_string://silence_stream://4000,0!", SWITCH_TEST_BASE_DIR_FOR_CONF, SWITCH_PATH_SEPARATOR, "sounds/agent.wav");
	fst_play_and_detect_speech_app_test("test",
		grammar,
		path,
		path2);
